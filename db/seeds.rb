...
# Products
product1 = Product.create(name: "Handmade cupcakes", description: "In all colors of the rainbow", price: 4.95, department: department1, photos: [photo1])
product2 = Product.create(name: "Loave", description: "Freshly baked everyday", price: 2.95, department: department1, photos: [photo2])
product3 = Product.create(name: "Layer cake", description: "Layer on top of layer", price: 14.95, department: department1, photos: [photo3])

product4 = Product.create(name: "Beef", description: "Best of the country", price: 4.90, department: department2, photos: [photo4])
product5 = Product.create(name: "Pork", description: "'t Tulpje's finest", price: 3.75, department: department2, photos: [photo5])
product6 = Product.create(name: "Poultry", description: "Best quality ever", price: 2.85, department: department2, photos: [photo6])

product7 = Product.create(name: "Paprika", description: "Never fresher", price: 0.99, department: department3, photos: [photo7])
product8 = Product.create(name: "Cucumber", description: "From Farmer Joe's", price: 0.75, department: department3, photos: [photo8])
product9 = Product.create(name: "Lettuce", description: "A must for every salad", price: 0.60, department: department3, photos: [photo9])

product10 = Product.create(name: "Lobster", description: "Treat yourself", price: 15.96, department: department4, photos: [photo10])
product11 = Product.create(name: "Shrimp", description: "Like no other", price: 3.45, department: department4, photos: [photo11])
product12 = Product.create(name: "Shellfish", description: "No rotten ones here", price: 6.75, department: department4, photos: [photo12])

product13 = Product.create(name: "Shampoo", description: "Smooth hair every day", price: 5.75, department: department5, photos: [photo13])
product14 = Product.create(name: "Conditioner", description: "Tangles be gone", price: 16.99, department: department5, photos: [photo14])
product15 = Product.create(name: "Aspirines", description: "Beats all sorts of headaches", price: 4.95, department: department5, photos: [photo15])
